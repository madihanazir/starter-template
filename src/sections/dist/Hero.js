...
exports.HeroSection = function () {
    return (React.createElement("section", { className: "w-full max-w-7xl mx-auto px-4 relative z-0 flex flex-col items-center justify-center min-h-screen overflow-hidden py-32 md:py-48 lg:py-60" },
        React.createElement("div", { className: "absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)] pointer-events-none flex items-center justify-center" },
            React.createElement("div", { className: "absolute inset-0 -z-30 opacity-10", style: { backgroundImage: "url(" + grain_jpg_1["default"].src + ")" } }),
            React.createElement("div", { className: "absolute flex items-center justify-center" },
            ...
            React.createElement(HeroOrbit_1.HeroOrbit, { size: 800, rotation: 72 },
                React.createElement(star_svg_1["default"], { className: "size-28 text-emerald-300" })),
            React.createElement(HeroOrbit_1.HeroOrbit, { size: 550, rotation: -500 },
                React.createElement(star_svg_1["default"], { className: "size-12 text-emerald-300" })),
            React.createElement(HeroOrbit_1.HeroOrbit, { size: 430, rotation: -35 },
                React.createElement(sparkle_svg_1["default"], { className: "size-8 text-emerald-300/20" })),
            React.createElement(HeroOrbit_1.HeroOrbit, { size: 440, rotation: 80 },
                React.createElement(sparkle_svg_1["default"], { className: "size-5 text-emerald-300/20" })),
            React.createElement(HeroOrbit_1.HeroOrbit, { size: 530, rotation: 350 },
                React.createElement(sparkle_svg_1["default"], { className: "size-10 text-emerald-300/20" })),
            React.createElement(HeroOrbit_1.HeroOrbit, { size: 710, rotation: 178 },
                React.createElement(sparkle_svg_1["default"], { className: "size-14 text-emerald-300/20" })),
            React.createElement(HeroOrbit_1.HeroOrbit, { size: 720, rotation: 20 },
                React.createElement("div", { className: "size-3 rounded-full bg-emerald-300/20" })),
            React.createElement(HeroOrbit_1.HeroOrbit, { size: 520, rotation: -41 },
                React.createElement("div", { className: "size-3 rounded-full bg-emerald-300/20" })),
            React.createElement(HeroOrbit_1.HeroOrbit, { size: 650, rotation: -5 },
                React.createElement("div", { className: "size-3 rounded-full bg-emerald-300/20" }))),
        React.createElement("div", { className: "relative z-10 flex flex-col items-center max-w-3xl mx-auto px-4" },
            ...
            React.createElement("div", { className: "bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg mt-4" },
                React.createElement("div", { className: "bg-green-500 size-2.5 rounded-full" }),
