...
exports.ContactSection = function () {
    return (React.createElement("div", { className: "py-16 pt-12 lg:py-24 lg:pt-20" },
        React.createElement("div", { className: "container" },
            React.createElement("div", { className: "bg-gradient-to-r from-emerald-300 to-sky-400 text-gray-900 py-8 px-10 rounded-3xl text-center md:text-left relative overflow-hidden z-0" },
                React.createElement("div", { className: "absolute inset-0 opacity-5 -z-10", style: {
                        backgroundImage: "url(" + grain_jpg_1["default"].src + ")"
                    } }, " "),
                React.createElement("div", { className: "flex flex-col md:flex-row gap-8 md:gap-16 items-center" },
